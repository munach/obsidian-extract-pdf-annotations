...
export class Formatter {
    private static readonly TITLE_LVL1 = "##### ";
    private static readonly LVL2_PREFIX = "- ";
    private static readonly LVL3_PREFIX = "\t- ";
    private static readonly SUMR_PREFIX = "- ";
    private static readonly IMPT_PREFIX = "- ";
    ...
    private getColorName(rgb: number[]) {
    ...
    private buildPreamble(currentFileName): string {
		...
		const l_title_lvl1 = "\n" + Formatter.TITLE_LVL1;
		const l_lvl2_prefix = Formatter.LVL2_PREFIX;
		const l_lvl3_prefix = Formatter.LVL3_PREFIX;
		const l_sumr_prefix = Formatter.SUMR_PREFIX;
		const l_impt_prefix = Formatter.IMPT_PREFIX;
		...
		l_FormattageText +=
			...
			lvl1_format +
			" Level 1 (" +
			this.getColorName(this.settings.level1RGB) +
			")" +
			lvl1_format +
			"\n";
		l_FormattageText +=
			...
			lvl2_format +
			" Level 2 (" +
			this.getColorName(this.settings.level2RGB) +
			")" +
			lvl2_format +
			"\n";
		l_FormattageText +=
			...
			lvl3_format +
			" Level 3 (" +
			this.getColorName(this.settings.level3RGB) +
			")" +
			lvl3_format +
			"\n";
		l_FormattageText +=
			...
			sumr_format +
			"Special level 1 (" +
			this.getColorName(this.settings.summryRGB) +
			")" +
			sumr_format +
			"\n";
		l_FormattageText +=
			...
			impt_format +
			"Special level 2 (" +
			this.getColorName(this.settings.imprttRGB) +
			")" +
			impt_format +
			"\n";
    ...
    public format(
		...
		grandtotal.forEach((anno) => {
			...
			if (l_pageNumber != anno.pageNumber) {
				...
				l_title_lvl1 = Formatter.TITLE_LVL1;
			}
